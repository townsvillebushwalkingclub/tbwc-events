...
- `GET /llms.txt` - Markdown guide for AI systems (club info and upcoming events). Discovered via `rel="describedby"` (HTML link + HTTP `Link` header) and explicitly allowed in `robots.txt`
